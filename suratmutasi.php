...
<html>
	<head>
		...
		<title>Surat Mutasi dari NZ_<?php echo $_POST['nama']; ?></title>
	...
	<body style="font-family:Poppins;background-color:white;">
		...
		<div style="background-color:#fe5000;padding:15px;text-align:center;">
		  <h1>Data Mutasi Kader dari New Zealand</h1>
		</div>
...
<?php
					if(!empty($_POST)) {
						...
						$sql = "SELECT * FROM mutasi WHERE no = '$no'";
...
?>
								...
								<tr>
									<td style="text-align:left;vertical-align:top;">Alamat Mutasi</td>
									<td style="vertical-align:top;">:</td>
									<td style="text-align:left;vertical-align:top;"><?php echo $row['alamatindo']; ?></td>
								</tr>

								<tr>
									<td style="text-align:left;vertical-align:top;">Telepon</td>
									<td style="vertical-align:top;">:</td>
									<td style="text-align:left;vertical-align:top;"><?php echo $row['telponindo']; ?></td>
								</tr>
								...
								<tr>
									<td style="text-align:left;vertical-align:top;">Lama Tarbiyah di NZ</td>
									<td style="vertical-align:top;">:</td>
									<td style="text-align:left;vertical-align:top;"><?php echo $row['tarbiyahnz'] . " Tahun"; ?></td>
								</tr>
								...
								<tr>
									<td style="text-align:left;vertical-align:top;">Tanggal Mutasi</td>
									<td style="vertical-align:top;">:</td>
									<td style="text-align:left;vertical-align:top;">
										<?php
											$d = $row['tglpindah'];
								...
								<tr>
									<td style="text-align:left;vertical-align:top;">Alasan Mutasi</td>
									<td style="vertical-align:top;">:</td>
								...
								<tr>
									<td style="text-align:left;"><b>Data Pembina</b></td>
								</tr>
