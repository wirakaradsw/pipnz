...
<html>
	...
	<body style="font-family:Poppins;background-color:#101820;">
		...
		<div style="background-color:#fe5000;padding:15px;text-align:center;">
		  <h1><a href="index.php">Data Kader di New Zealand</a></h1>
		</div>
...
<?php 
							$sql = "SELECT * FROM masuk WHERE aktif = 1";
									...
									<tr style="background-color:#FFD580;">
										<td>
											<?php
												...
												$nama = $row['nama'];
											?>
											<form target="print_popup" name="tampilkansurat" method="post" action="suratmasuk.php" onsubmit="window.open('about:blank','print_popup','width=833,height=1179');">
												<input type="hidden" name="id" value="<?php echo $id;?>">
												<input type="hidden" name="nama" value="<?php echo $nama;?>">
												<input type="submit" name="idsurat" value="<?php echo $no;?>" size="50%" style="font-size:100%;font-family:Poppins;">
											</form>
										</td>
										<td style="text-align:left;"><?php echo $row['nama']; ?></td>
										<td style="text-align:left;"><?php echo $row['kotanz']; ?></td>
										<td style="text-align:left;"><?php echo $row['telponnz']; ?></td>
										<td style="text-align:left;"><?php echo $row['anggota']; ?></td>
									</tr>
<?php 
									$no++;
